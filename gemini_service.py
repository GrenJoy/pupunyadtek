...
Время публикации: {post_time_kyiv.strftime("%H:%M %d.%m.%Y")}
...
- Если ≥6 групп (1.1, 2.1 и т.д.) с интервалами И НЕТ слов "зміни", "включення", "подовжено", "додатково" → full_tomorrow
- Если есть "графік", "ГПВ", "черга" и дата завтрашняя И НЕТ слов "зміни" → full_tomorrow
- Если есть "зміни", "включення", "подовжено", "додатково" И ≥6 групп → partial_tomorrow (частичное обновление)
- Если "до 00:", "до 01:", "до 02:", "до 03:" и время ≥21:00 → partial_tomorrow
- Если "З 22:", "З 23:", "З 00:" → partial_tomorrow
- Если "відновлення", "включено", "до 22:30", "заплановано відключення" → partial_today или partial_tomorrow
- Если просто "графік на 4 грудня" → full_tomorrow
- Если "Відбулися деякі зміни" И много групп → partial_tomorrow (это частичное обновление!)
